...
user in an INI file next to zmPortable.exe called zmPortable.ini.
...
copy AppNamePortable.ini from this directory to zmPortable.ini next to
zmPortable.exe. The options in the INI file are as follows:
